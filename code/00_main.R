...
# SP request
sp_fld = paste0(input_dta_fld,"/social_policy_request")
...
# Single and multi hazard analysis  
if(hazard_exposure == 1) {
      
  source(paste0(code_data_root_fld,  "4a.hazard_exposure.R"))
      
  print("Script HAZARD exposure analysis - Done.")
